...
A fund's yield (the income generated to investors through interest and dividends) has a negative correlation with returns.
...
sector_data %>%
  ...
  labs(title = "Sectors vs. Annual Return",
       ...
       caption = "Source: Yahoo Finance")
```
In the shorterm many sectors were less than or near 0% returns. A few (most notably, the technology sector) surpassed the benchmark of the S&P 500, which tracks the performance of the top 500 companies.
...
Overall, the investments that have best performed in the past year were growth focused investments in the technology sector.
Due to the pandemic, there was immense growth in the technology sector during the past year as people moved to a digital environment. However, the technology sector still outperformed the rest of the sectors during the past 5 years.
